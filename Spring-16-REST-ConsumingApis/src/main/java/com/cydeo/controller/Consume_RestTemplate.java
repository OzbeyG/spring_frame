...
public class Consume_RestTemplate {
    ...
    public User[] readAllUsers() {
        ResponseEntity<User[]> responseEntity = restTemplate.getForEntity(URI, User[].class);//RestTemplate use array as background
    ...
    @GetMapping("/test")
    public ResponseEntity<Object> consumeFromDummyApi(){ //https://dummyapi.io/data/v1/user?limit=10
